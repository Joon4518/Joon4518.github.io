...
<body>
	...
	<div class="container">
		<form method="post" action="TIMESERIESAction.jsp">
			<label> x축  데이터 </label><input type="text" class="form-control" name="x" placeholder="x축을 입력하세요  ex) 2013-11-01">
	...
	<br>	
		<div class="jumbotron" style="padding-top: 20px;">
			<h3 style="text-align: center;">TIMESERIES차트</h3>
		</div>
